...
```{r}
# Objective: trying to find the number of bureaucrats who got demoted yet (re)promoted afterwards by province
datapath <- './ps2_data/FullData.xlsx'
df <- readxl::read_xlsx(datapath)
