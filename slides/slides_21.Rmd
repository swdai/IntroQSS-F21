...
- how to find out what your working directory is (`getwd()`)
- how to specify a relative path using code completion (tab key)
- how to use code completion for other things (variable names, function names, function arguments, help file extracts)
